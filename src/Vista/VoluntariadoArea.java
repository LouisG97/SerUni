...
public class VoluntariadoArea extends javax.swing.JFrame {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        VoluntariadoAgregarArea u = new VoluntariadoAgregarArea();
        u.setVisible(true);
    ...
    private void btnNuevo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevo1ActionPerformed
        if(row==1){
            VoluntariadoModificarArea u = new VoluntariadoModificarArea();
            u.setVisible(true);
            u.iniciar(newId);
            u.datos(nombre,prioridad,usuario,area,contraseña);
            this.dispose();
    ...
    private void btnListaVoluntarios1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListaVoluntarios1ActionPerformed
        if(row==1){
            VoluntariadoHorasArea u = new VoluntariadoHorasArea();
            u.setVisible(true);
            u.iniciar(newId);
            u.datos(nombre,prioridad,usuario,area,contraseña);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoluntariadoArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VoluntariadoArea().setVisible(true);
            }
        });
    }
