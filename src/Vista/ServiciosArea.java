 ...
 * @author j_k_h
 */
public class ServiciosArea extends javax.swing.JFrame {

    /**
     * Creates new form IniciarSesion
     */
    public ServiciosArea() {
        initComponents();
    ...
    private void jtfBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfBuscarKeyReleased
        ...
        try{
        s = n.buscarID5("nombreDelServicio",jtfBuscar.getText(),"area",area);
...
"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiciosArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServiciosArea().setVisible(true);
            }
        });
    }
