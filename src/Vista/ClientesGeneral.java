 ...
 * @author j_k_h
 */
public class ClientesGeneral extends javax.swing.JFrame {
...
"";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientesGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesGeneral().setVisible(true);
            }
        });
    }
